    ...
    <section className="py-32 bg-neutral-950">
      <div className="container mx-auto">
        ...
        <Tabs defaultValue={tabs[0].value} className="mt-8">
          <TabsList
            ...
            {tabs.map((tab) => (
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="flex items-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-muted-foreground 
          ...
          <div
            className="mx-auto mt-8 max-w-screen-xl rounded-2xl bg-muted/70 p-6 lg:p-16 bg-neutral-900">
            {tabs.map((tab) => (
              <TabsContent
                key={tab.value}
                value={tab.value}
